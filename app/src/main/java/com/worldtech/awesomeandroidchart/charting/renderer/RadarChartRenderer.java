...
import com.worldtech.awesomeandroidchart.charting.charts.RadarChart;
...
public class RadarChartRenderer extends LineRadarRenderer {
    ...
    public RadarChartRenderer(RadarChart chart, ChartAnimator animator,
        ...
        mdotPaint=new Paint();
        list=new ArrayList<>();
        mdotPaint.setColor(Color.rgb(51,51,51));
        mdotPaint.setStrokeWidth(Utils.convertDpToPixel(4));
    ...
    protected void drawDataSet(Canvas c, IRadarDataSet dataSet, int mostEntries) {
        ...
        for (int j = 0; j < dataSet.getEntryCount(); j++) {
           ...
           if (list!=null){
               list.add(new MPPointF(pOut.x,pOut.y));
           }
        ...
        if (list!=null){
            for (int i = 0; i < list.size(); i++) {
                ...
                c.drawCircle(mpPointF.x,mpPointF.y,10,mdotPaint);
            }
            list.clear();
        }
...
//                c.drawLine(p1out.x, p1out.y, p2out.x, p2out.y, mWebPaint);
            ...
            c.drawCircle(center.x,center.y,factor*j,mWebPaint);
        }
